...
De plus, on ne considèrera pas les sauts du aux décalages horaires (passage heure d'été / heure d'hiver) comme des trous dans les données. On les traitera les données "redondantes" comme des observations normales et on ommettra les observations sautées lord du passage à l'heure d'été.
